...
public class Vender_Changepssword_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vender__changepssword);
    ...
    public void validation(){
        if(str_current_pwd.equals("")){
            ...
            if(!str_new_pwd.equals(str_confirm_pwd)){
                ...
                Toast toast = Toast.makeText(Vender_Changepssword_Activity.this,"New password and confirm password is not matching", Toast.LENGTH_LONG);
    ...
    private void ChangePasword_api() {
        final ProgressDialog pd = new ProgressDialog(Vender_Changepssword_Activity.this);
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, urll, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObject.getString("success").equalsIgnoreCase("true")) {
                        ...
                        Toast toast = Toast.makeText(Vender_Changepssword_Activity.this,message, Toast.LENGTH_LONG);
                        toast.setGravity(Gravity.CENTER, 0, 0);
                        toast.show();
                        pd.dismiss();
                        Intent ints = new Intent(Vender_Changepssword_Activity.this,Login_Activity.class);
                        startActivity(ints);
                        finish();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof NetworkError) {
                    Toast.makeText(Vender_Changepssword_Activity.this, "Cannot connect to Internet...Please check your connection!", Toast.LENGTH_SHORT).show();
                } else if (error instanceof ServerError) {
                    Toast.makeText(Vender_Changepssword_Activity.this, "The server could not be found. Please try again after some time!!", Toast.LENGTH_SHORT).show();
                } else if (error instanceof AuthFailureError) {
                    Toast.makeText(Vender_Changepssword_Activity.this, "Cannot connect to Internet...Please check your connection!", Toast.LENGTH_SHORT).show();
                } else if (error instanceof ParseError) {
                    Toast.makeText(Vender_Changepssword_Activity.this, "Parsing error! Please try again after some time!!", Toast.LENGTH_SHORT).show();
                } else if (error instanceof NoConnectionError) {
                    Toast.makeText(Vender_Changepssword_Activity.this, "Cannot connect to Internet...Please check your connection!", Toast.LENGTH_SHORT).show();
                } else {
                    if (error instanceof TimeoutError) {
                        Toast.makeText(Vender_Changepssword_Activity.this, "Connection TimeOut! Please check your internet connection.", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Vender_Changepssword_Activity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
        })
