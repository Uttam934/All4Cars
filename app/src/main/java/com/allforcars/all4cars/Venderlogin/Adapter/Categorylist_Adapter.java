...
public class Categorylist_Adapter extends RecyclerView.Adapter<Categorylist_Adapter.ViewHolder> {
    ...
    public Categorylist_Adapter(Context context, ArrayList<Categorylist_Model> Recyclemodel ) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.vendercatogrylist, parent, false);
