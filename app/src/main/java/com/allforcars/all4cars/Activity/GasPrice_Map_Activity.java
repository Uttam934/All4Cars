...
public class GasPrice_Map_Activity extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    RelativeLayout forget_help;
    String comppanyname,Diesel,branch_list,phone,latitude,logitude,Distance,name,getstrlatitude="",getstrlogtitude="",Catergorylist="",barandlist,name_key="1";
    TextView Name_text;
    GPSTracker gps;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forget_help =findViewById(R.id.forget_help);

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
        mapFragment.getMapAsync(GasPrice_Map_Activity.this);
        ...
        forget_help.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        gps = new GPSTracker(GasPrice_Map_Activity.this);
        ...
        if (isOnline()) {
            ...
            Toast.makeText(GasPrice_Map_Activity.this, "Cannot connect to Internet...Please check your connection!", Toast.LENGTH_LONG).show();
...

    {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(GasPrice_Map_Activity.this);
            ...
            public void onErrorResponse(VolleyError error) {
               ...
               progressDialog.dismiss();
                if (error instanceof NetworkError) {
                    Toast.makeText(GasPrice_Map_Activity.this, "Cannot connect to Internet...Please check your connection!", Toast.LENGTH_SHORT).show();
                } else if (error instanceof ServerError) {
                    Toast.makeText(GasPrice_Map_Activity.this, "The server could not be found. Please try again after some time!!", Toast.LENGTH_SHORT).show();
                } else if (error instanceof AuthFailureError) {
                    Toast.makeText(GasPrice_Map_Activity.this, "Cannot connect to Internet...Please check your connection!", Toast.LENGTH_SHORT).show();
                } else if (error instanceof ParseError) {
                    Toast.makeText(GasPrice_Map_Activity.this, "Parsing error! Please try again after some time!!", Toast.LENGTH_SHORT).show();
                } else if (error instanceof NoConnectionError) {
                    Toast.makeText(GasPrice_Map_Activity.this, "Cannot connect to Internet...Please check your connection!", Toast.LENGTH_SHORT).show();
                } else {
                    if (error instanceof TimeoutError) {
                        Toast.makeText(GasPrice_Map_Activity.this, "Connection TimeOut! Please check your internet connection.", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(GasPrice_Map_Activity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                Intent ints = new Intent(GasPrice_Map_Activity.this,Deatail_Activity.class);
                ints.putExtra("Map_show", "Gas_price");
    ...
    public void createMarker(double latitude, double longitude,String comppanyname, String Petrol,String Diesel,String Gas) {
        ...
        customInfoWindow = new CustomInfoWindowGasPrice(GasPrice_Map_Activity.this);
        mMap.setInfoWindowAdapter(customInfoWindow);




        BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.gasprice);
