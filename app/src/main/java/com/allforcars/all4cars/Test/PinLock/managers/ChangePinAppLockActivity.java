...
public abstract class ChangePinAppLockActivity extends PinActivity implements KeyboardButtonClickedListener, View.OnClickListener, FingerprintUiHelper.Callback {

    public static final String TAG = ChangePinAppLockActivity.class.getSimpleName();
        ...
        Thread thread = new Thread() {
            public void run() {
                ...
                Animation animation = AnimationUtils.loadAnimation(
                        ChangePinAppLockActivity.this, R.anim.shake);
    ...
    public int getPinLength() {
        return ChangePinAppLockActivity.DEFAULT_PIN_LENGTH;
    }

    /**
     * Get the current class extending {@link ChangePinAppLockActivity} to re-enable {@link AppLock}
     * in case it has been collected
     *
     * @return the current class extending {@link ChangePinAppLockActivity}
     */
    public Class<? extends ChangePinAppLockActivity> getCustomAppLockActivityClass() {
