...
import com.allforcars.all4cars.Test.PinLock.managers.ChangePinAppLockActivity;
 ...
 */
public class CustomChangePinActivity extends ChangePinAppLockActivity {
    ...
    public void showForgotDialog() {
        ...
        customDialog.setClickListener(new CustomDialog.ClickListener() {
            ...
            public void onConfirmClick() {
                // confirm password
//                Intent intent = new Intent(CustomChangePinActivity.this, ConfirmPasswordActivity.class);
