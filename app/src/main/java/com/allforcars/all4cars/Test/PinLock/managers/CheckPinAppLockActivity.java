...
public abstract class CheckPinAppLockActivity extends PinActivity implements KeyboardButtonClickedListener, View.OnClickListener, FingerprintUiHelper.Callback {

    public static final String TAG = CheckPinAppLockActivity.class.getSimpleName();
    ...
    private void initLayout(Intent intent) {
        ...
        getSupportActionBar().setTitle("Check PinCode");
        ...
        Thread thread = new Thread() {
            public void run() {
                ...
                Animation animation = AnimationUtils.loadAnimation(
                        CheckPinAppLockActivity.this, R.anim.shake);
    ...
    public int getPinLength() {
        return CheckPinAppLockActivity.DEFAULT_PIN_LENGTH;
    }

    /**
     * Get the current class extending {@link CheckPinAppLockActivity} to re-enable {@link AppLock}
     * in case it has been collected
     *
     * @return the current class extending {@link CheckPinAppLockActivity}
     */
    public Class<? extends CheckPinAppLockActivity> getCustomAppLockActivityClass() {
