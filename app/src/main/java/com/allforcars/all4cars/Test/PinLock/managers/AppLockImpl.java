...
import com.allforcars.all4cars.Test.PinLock.PinCompatActivity;
import com.allforcars.all4cars.Test.PinLock.PinFragmentActivity;
import com.allforcars.all4cars.Test.PinLock.enums.Algorithm;
import com.allforcars.all4cars.Test.PinLock.interfaces.LifeCycleInterface;

import java.security.SecureRandom;
import java.util.Arrays;

public class AppLockImpl<T extends CheckPinAppLockActivity> extends AppLock implements LifeCycleInterface {
     ...
     * @param activityClass The activity extending {@link CheckPinAppLockActivity}
     * @return The instance.
     */
    public static AppLockImpl getInstance(Context context, Class<? extends CheckPinAppLockActivity> activityClass) {
    ...
    public static SharedPreferences getShared(Context context) {
       ...
       return mSharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public boolean setPasscode(String passcode){
        ...
        if (passcode == null) {
            ...
            //QuickStartPreferences.setString(context,QuickStartPreferences.PIN_CODE_PASSWORD,passcode);
          /*  passcode = salt + passcode + salt;
    ...
    public boolean shouldLockSceen(Activity activity) {
        ...
        // already unlock
        if (activity instanceof CheckPinAppLockActivity) {
            CheckPinAppLockActivity ala = (CheckPinAppLockActivity) activity;
    ...
    public void onActivityPaused(Activity activity) {
        ...
        if ((onlyBackgroundTimeout() || !shouldLockSceen(activity)) && !(activity instanceof CheckPinAppLockActivity)) {
            setLastActiveMillis();
        }
    }
    ...
    public void onActivityResumed(Activity activity) {
        ...
        if (!shouldLockSceen(activity) && !(activity instanceof CheckPinAppLockActivity)) {
            setLastActiveMillis();
        }
    }
}
