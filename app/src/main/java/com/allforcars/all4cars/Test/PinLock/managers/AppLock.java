...
public abstract class AppLock {
     ...
     */
    public static final long DEFAULT_TIMEOUT = 1000 * 100000; // 10sec
    ...
    /**
     * Get whether the user backed out of the {@link CheckPinAppLockActivity} previously
     */
    public abstract boolean pinChallengeCancelled();

    /**
     * Set whether the user backed out of the {@link CheckPinAppLockActivity}
     */
