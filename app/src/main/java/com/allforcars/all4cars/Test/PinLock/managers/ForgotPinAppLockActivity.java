...
public abstract class ForgotPinAppLockActivity extends PinActivity implements KeyboardButtonClickedListener, View.OnClickListener, FingerprintUiHelper.Callback {

    public static final String TAG = ForgotPinAppLockActivity.class.getSimpleName();
    ...
    private void initLayout(Intent intent) {
        ...
        getSupportActionBar().setTitle("Update PinCode");
        ...
        Thread thread = new Thread() {
            public void run() {
                ...
                Animation animation = AnimationUtils.loadAnimation(
                        ForgotPinAppLockActivity.this, R.anim.shake);
    ...
    public int getPinLength() {
        return ForgotPinAppLockActivity.DEFAULT_PIN_LENGTH;
    }

    /**
     * Get the current class extending {@link ForgotPinAppLockActivity} to re-enable {@link AppLock}
     * in case it has been collected
     *
     * @return the current class extending {@link ForgotPinAppLockActivity}
     */
    public Class<? extends ForgotPinAppLockActivity> getCustomAppLockActivityClass() {
