 ...
 *         01/04/2017
 */
public class PinView_6 extends AppCompatEditText {
    ...
    public PinView_6(Context context) {
        this(context, null);
    }

    public PinView_6(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.pinViewStyle);
    }

    public PinView_6(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.PinView_6, defStyleAttr, 0);

        mViewType = a.getInt(R.styleable.PinView_6_viewType, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(R.styleable.PinView_6_itemCount, DEFAULT_COUNT);
        mPinItemSize = a.getDimensionPixelSize(R.styleable.PinView_6_itemSize,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_size));
        mPinItemHeight = mPinItemWidth = mPinItemSize;
        if (a.hasValue(R.styleable.PinView_6_itemHeight)) {
            mPinItemHeight = a.getDimensionPixelOffset(R.styleable.PinView_6_itemHeight,
                    res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_size));
        }
        if (a.hasValue(R.styleable.PinView_6_itemWidth)) {
            mPinItemWidth = a.getDimensionPixelOffset(R.styleable.PinView_6_itemWidth,
                    res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_size));
        }
        mPinItemSpacing = a.getDimensionPixelOffset(R.styleable.PinView_6_itemSpacing,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = a.getDimensionPixelOffset(R.styleable.PinView_6_itemRadius,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_radius));
        mLineWidth = a.getDimensionPixelOffset(R.styleable.PinView_6_borderWidth,
                res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.PinView_6_borderColor);
        if (a.hasValue(R.styleable.PinView_6_lineWidth)) {
            mLineWidth = a.getDimensionPixelOffset(R.styleable.PinView_6_lineWidth,
                    res.getDimensionPixelOffset(R.dimen.pv_pin_view_item_line_width));
        }
        if (a.hasValue(R.styleable.PinView_6_lineColor)) {
            mLineColor = a.getColorStateList(R.styleable.PinView_6_lineColor);
        }
