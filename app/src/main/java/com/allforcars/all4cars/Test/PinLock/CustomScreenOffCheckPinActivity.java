...
import com.allforcars.all4cars.Test.PinLock.managers.ScreenOffCheckPinActivity;
 ...
 */
public class CustomScreenOffCheckPinActivity extends ScreenOffCheckPinActivity {
    ...
    public void showForgotDialog() {
        ...
        customDialog.setClickListener(new CustomDialog.ClickListener() {
            ...
            public void onConfirmClick() {
             ...
             /*   LoginActivity.UPDATE_PIN="checkpin";
                Intent intent=new Intent(CustomScreenOffCheckPinActivity.this, CheckSecurityPhraseActivity.class);
